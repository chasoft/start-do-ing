// icon:arrow-expand-all | Material Design Icons https://materialdesignicons.com/ | Austin Andrews
import * as React from "react"

export function IconArrowExpand(props: React.SVGProps<SVGSVGElement>) {
	return (
