...
function MobileMenuItem({ blocks, onClick }: { blocks: Block<unknown>[], onClick: () => void }) {
	return (
		<details open>
		...
		<ul className="py-3 menu">
			...
			<li>
				<a href="/theme-generator/" className="group">
					<span>
						<svg className="w-5 h-5 text-fuchsia-400" width="18" height="18" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
			...
			<li>
				<a href="/store/" className="group">
					<span>
						<svg className="w-5 h-5" width="18" height="18" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
					...
					<span>Store</span> <span className="font-mono badge badge-sm badge-primary">new</span>
				</a>
			</li>
			<li>
			...
			<li>
				<a href="/tailwindplay/" target="_blank" rel="noopener noreferrer" className="group">
					<span>
						<svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5" fill="none" viewBox="0 0 54 33">
			...
			<li>
				<a href="https://github.com/saadeghi/daisyui" target="_blank" rel="noopener noreferrer" className="group">
					<span>
						<svg width="18" height="18" className="w-5 h-5" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
