...
export function DateTimeAnalogClockContent({ className, layoutId }: { className?: string, layoutId: DateTimeLayoutId }) {
	const urlSharingData = getUrlSharingData(DATE_TIME_ANALOG_CLOCK)
	return (
