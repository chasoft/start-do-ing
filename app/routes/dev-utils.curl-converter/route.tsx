...
const layoutId: PageId = "dev-utils-curl-converter";
...
export const handle: CustomRouteHandle = {
	layoutId,
	breadcrumb: () => <Link to={DEV_UTILS_CURL_CONVERTER.to}>{DEV_UTILS_CURL_CONVERTER.title}</Link>,
};

export default function DevUtilsCurlConverterRoute() {
	return (
		<DevUtilsCurlConverterContent layoutId={layoutId} />
	)
}
