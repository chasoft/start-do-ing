...
const layoutId: PageId = "dev-utils-string-converter";
...
export const handle: CustomRouteHandle = {
	layoutId,
	breadcrumb: () => <Link to={DEV_UTILS_STRING_CONVERTER.to}>{DEV_UTILS_STRING_CONVERTER.title}</Link>,
};

export default function DevUtilsStringConverterRoute() {
	return (
		<DevUtilsStringConverterContent layoutId={layoutId} />
	)
}
