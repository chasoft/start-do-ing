...
const layoutId: PageId = "dev-utils-sql-formatter";
...
export const handle: CustomRouteHandle = {
	layoutId,
	breadcrumb: () => <Link to={DEV_UTILS_SQL_FORMATTER.to}>{DEV_UTILS_SQL_FORMATTER.title}</Link>,
};

export default function DevUtilsSqlFormatterRoute() {
	return (
		<DevUtilsSqlFormatterContent layoutId={layoutId} />
	)
}
